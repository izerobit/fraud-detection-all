...
public class ProduceWindowState {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, JsonProcessingException {
        ...
        while (true){
            Rule rule = new Rule();
            rule.setControlType(Rule.ControlType.EXPORT_WINDOW_CURRENT);
            ...
            System.out.println("write rule control msg EXPORT_WINDOW_CURRENT");
